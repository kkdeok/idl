...
public final class SearchServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "apis.search.v1.SearchService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.kkdeok.idl.apis.search.v1.SearchRequest,
      com.kkdeok.idl.apis.search.v1.SearchResponse> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Search",
      requestType = com.kkdeok.idl.apis.search.v1.SearchRequest.class,
      responseType = com.kkdeok.idl.apis.search.v1.SearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kkdeok.idl.apis.search.v1.SearchRequest,
      com.kkdeok.idl.apis.search.v1.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<com.kkdeok.idl.apis.search.v1.SearchRequest, com.kkdeok.idl.apis.search.v1.SearchResponse> getSearchMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchMethod = SearchServiceGrpc.getSearchMethod) == null) {
          SearchServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<com.kkdeok.idl.apis.search.v1.SearchRequest, com.kkdeok.idl.apis.search.v1.SearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kkdeok.idl.apis.search.v1.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kkdeok.idl.apis.search.v1.SearchResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void search(com.kkdeok.idl.apis.search.v1.SearchRequest request,
        io.grpc.stub.StreamObserver<com.kkdeok.idl.apis.search.v1.SearchResponse> responseObserver) {
  ...
  public static final class SearchServiceStub
    ...
    /**
     */
    public void search(com.kkdeok.idl.apis.search.v1.SearchRequest request,
        io.grpc.stub.StreamObserver<com.kkdeok.idl.apis.search.v1.SearchResponse> responseObserver) {
  ...
  public static final class SearchServiceBlockingV2Stub
    ...
    /**
     */
    public com.kkdeok.idl.apis.search.v1.SearchResponse search(com.kkdeok.idl.apis.search.v1.SearchRequest request) throws io.grpc.StatusException {
  ...
  public static final class SearchServiceBlockingStub
    ...
    /**
     */
    public com.kkdeok.idl.apis.search.v1.SearchResponse search(com.kkdeok.idl.apis.search.v1.SearchRequest request) {
  ...
  public static final class SearchServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kkdeok.idl.apis.search.v1.SearchResponse> search(
        com.kkdeok.idl.apis.search.v1.SearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((com.kkdeok.idl.apis.search.v1.SearchRequest) request,
              (io.grpc.stub.StreamObserver<com.kkdeok.idl.apis.search.v1.SearchResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.kkdeok.idl.apis.search.v1.SearchRequest,
              com.kkdeok.idl.apis.search.v1.SearchResponse>(
  ...
  private static abstract class SearchServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.kkdeok.idl.apis.search.v1.SearchProto.getDescriptor();
    }
